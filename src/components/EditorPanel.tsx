        ...
        <div className="flex items-center gap-2">
          ...
          {onLoadDemo && (
            <button
              type="button"
              onClick={onLoadDemo}
              className="px-2.5 py-1 rounded bg-slate-800 hover:bg-slate-700 text-slate-300 hover:text-white border border-slate-700 hover:border-slate-600 transition-colors flex items-center gap-1 text-[11px] font-medium cursor-pointer"
